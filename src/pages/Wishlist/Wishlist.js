...
import { Navbar, HotelCard, AuthModal } from "../../components";//, Alert  ProfileDropDown,
import { useWishlist, useAuth } from "../../context";//, useAlert
import "./Wishlist.css";

export const Wishlist = () => {
  const { wishlist } = useWishlist();
  const { isAuthModalOpen } = useAuth();//, isDropDownModalOpen
